...
const Banner = () => {
    return (
        <div className='container mx-auto bg-gray-800 p-10 grid grid-cols-1 md:grid-cols-2 gap-5  my-10 rounded-2xl'>
            <div className='space-y-10'>
                <p className='text-[#c2f800] '>WORKOUT LIBRARY</p>
                <h1 className={`text-2xl md:text-5xl text-white font-bold ${oswald.className}`}>TRAIN WITH INTENT. LOG <br /> EVERY SET.</h1>
